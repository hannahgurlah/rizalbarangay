      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 sm:py-40">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-6 leading-tight">
            Welcome to Barangay Rizal, Pinamungajan
          </h1>
          <p className="text-lg sm:text-xl mb-4 text-primary-100 leading-relaxed">
            Stay updated with our latest news, programs, and community services designed to keep every Rizalian informed and connected. Together, let's continue building a progressive and united Barangay Rizal!
          </p>
