export default function OnlineServicesHero() {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 sm:py-40">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg sm:text-xl mb-4 text-primary-100 leading-relaxed">
            Enjoy hassle-free transactions – request certificates, send inquiries, and access public information anytime, anywhere.
          </p>
        </div>
      </div>
    </section>
