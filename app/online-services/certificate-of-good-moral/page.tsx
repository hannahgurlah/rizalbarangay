...
export default function CertificateOfGoodMoralPage() {
  return (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Certificate of Good Moral</h2>
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed mb-6">
                Request a Certificate of Good Moral Character online. This document certifies that you have no pending cases or derogatory records in Barangay Rizal.
              </p>
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700 mb-6">
                ...
                <li>Wait for background verification</li>
              ...
              <div className="bg-primary-50 p-6 rounded-lg">
                ...
                <p className="text-gray-700">Certificate of Good Moral is typically issued within 2-3 business days after verification.</p>
              </div>
            </div>
          </div>
        </div>
